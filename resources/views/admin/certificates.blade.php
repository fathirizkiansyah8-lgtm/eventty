    ...
    <aside class="sidebar admin-sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <div class="sidebar-section">
                ...
                <a href="{{ url('/admin/certificates') }}" class="sidebar-link active">
                    <span class="sidebar-link-icon">🏆</span>
        ...
        <div class="certificates-content">
            ...
            <div class="search-filter-bar">
                <div class="search-box">
                    <input type="text" class="input-field" id="searchInput" placeholder="Cari sertifikat...">
                </div>
                <div class="filter-box">
                    <select class="input-field" id="eventFilter">
                        <option value="">Semua Event</option>
                        <option value="workshop-leadership">Workshop Leadership</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn btn-outline btn-sm action-btn">Lihat</button>
                                    <button class="btn btn-primary btn-sm action-btn">Generate</button>
                                    <button class="btn btn-outline btn-sm action-btn">Download</button>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn btn-outline btn-sm action-btn">Lihat</button>
                                    <button class="btn btn-primary btn-sm action-btn">Generate</button>
                                    <button class="btn btn-outline btn-sm action-btn" disabled>Download</button>
                                </div>
                            </td>
                        </tr>
                        <tr>
