...
<head>
    ...
    <title>Pengaturan - Eventty</title>
...
<body>
    ...
    <aside class="sidebar admin-sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <span class="sidebar-brand">Eventy</span>
        </div>
    ...
    <main class="main-content">
        ...
        <div class="dashboard-content">
            <div class="section-header">
                <h1 class="section-title">Pengaturan Admin</h1>
            </div>
            <p>Halaman pengaturan admin. Fitur ini akan segera tersedia.</p>
        </div>
    </main>
