    ...
    <div class="dashboard-content">
        ...
        <div class="event-card">
            <div class="event-banner" style="height: 250px;">
                <img src="{{ asset('images/events/design-competition-placeholder.jpg') }}" alt="Classmeeting" onerror="this.style.display='none'" style="width: 100%; height: 100%; object-fit: cover;">
            ...
            <div class="event-content">
                <h1 class="event-title" style="font-size: 2rem; margin-bottom: var(--spacing-md);">Classmeeting</h1>
                ...
                <div style="margin-bottom: var(--spacing-lg);">
                    ...
                    <p style="color: var(--text-muted); line-height: 1.8;">
                        Classmeeting adalah kompetisi antar kelas yang berisi berbagai pertandingan olahraga dan seni. 
                        Setiap kelas akan bertanding dalam berbagai kategori untuk memperebutkan gelar juara. Acara ini bertujuan untuk mempererat solidaritas antar kelas dan mengembangkan bakat siswa.
                    </p>
                </div>

                <div style="margin-bottom: var(--spacing-lg);">
                    <h3 style="font-size: 1.125rem; font-weight: 600; margin-bottom: var(--spacing-sm); color: var(--text-primary);">Kategori Lomba</h3>
                ...
                <div style="margin-bottom: var(--spacing-lg);">
                    ...
                    <ul style="color: var(--text-muted); line-height: 1.8; padding-left: var(--spacing-lg);">
                        ...
                        <li>Wajib mengenakan seragam olahraga kelas</li>
                        <li>Sehat jasmani dan rohani</li>
                        <li>Tepat waktu (07:30 WIB)</li>
                    </ul>
                </div>
                ...
                <div style="margin-bottom: var(--spacing-lg);">
                    ...
                    <div style="display: flex; align-items: center; gap: var(--spacing-md);">
                        <div style="flex: 1; height: 12px; background: var(--bg-secondary); border-radius: 6px; overflow: hidden;">
                            <div style="width: 94%; height: 100%; background: var(--warning); border-radius: 6px;"></div>
                        </div>
                        <span style="color: var(--text-primary); font-size: 0.875rem; font-weight: 600;">47/50 peserta</span>
                    </div>
                    <p style="color: var(--text-muted); font-size: 0.875rem; margin-top: var(--spacing-xs);">Sisa 3 kuota tersedia</p>
                </div>
                ...
                <div style="margin-bottom: var(--spacing-lg); padding: var(--spacing-md); background: var(--bg-secondary); border-radius: var(--radius-md); border: 1px solid var(--border-color);">
                    ...
                    <ul style="color: var(--text-muted); line-height: 1.8; padding-left: var(--spacing-lg);">
                        <li>Pendaftaran per kelas</li>
                        <li>Sertifikat juara akan diberikan</li>
                        <li>Hadiah untuk pemenang</li>
                        <li>Snack dan minuman disediakan</li>
                    </ul>
                </div>
